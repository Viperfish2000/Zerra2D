...
public enum EnumDirection {
	...
	private static final Map<String, EnumDirection> NAME_LOOKUP = new HashMap<String, EnumDirection>();
	...
	public static EnumDirection byId(int index) {
		return EnumDirection.values()[Math.abs(index % EnumDirection.values().length)];
	}
